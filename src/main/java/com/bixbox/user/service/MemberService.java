...
import com.bixbox.user.exception.InSufficientCreditException;
...
public class MemberService {
    ...
    public Member updateMemberInfo(String memberId, MemberUpdateDto memberUpdateDto) {
        ...
        Member result = Member.convertMemberForUpdate(memberInfo, memberUpdateDto);
//        result.setUpdatedAt(LocalDateTime.now());
    ...
    public Member modifyMemberInfo(MemberAuthorityUpdateDto memberUpdateDto) {
        ...
        memberInfo.setMemberAuthority(memberUpdateDto.getMemberAuthority());
