...
public class AttendanceServiceTest {
    ...
    public void addAttendance(int num, Member memberInfo) {
    ...
    public void entrace() {
        ...
        AttendanceStatus result = attendanceService.memberEntrance(1L, location);
...
//
//        assertThatThrownBy(() -> attendanceService.memberEntrance(1L, location))
...
//        attendanceService.memberQuit(1L, location);
//    }
//
...
//        CurrentLocationDto location = CurrentLocationDto.builder().lat(37.5046).lng(127.0376).build();
//
//        assertThatThrownBy(() -> attendanceService.memberQuit(1L, location))
//                .isInstanceOf(DuplicationEmailException.class)
//                .hasMessage("교육장과 멀리 떨어져 있습니다.");
//    }
//
...
//    }
//
//    public Boolean checkAttendanceDate(LocalDate before, LocalDate after, List<Attendance> attendanceList) {
